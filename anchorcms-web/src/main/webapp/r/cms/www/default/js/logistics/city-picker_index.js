    ...
    CityPicker.prototype = {
        ...
        bind: function () {
            ...
            this.$dropdown.on('click', '.city-select a', function () {
                ...
                //$(this).parents('.city-select').next(".city").find("a").removeClass('active');
        ...
        feedText: function () {
            ...
            this.$textspan.find('>.title').find('>.select-item').each(function(a,b){
            	if(a==0){
            		namep= $(this).html();
            	}else{
            		namep= namep+$(this).html();
            	}
            })
            if(namep.length<17){
            		this.$textspan.parent().css("line-height","48px");
            }else{
            	this.$textspan.parent().css("line-height","");
            }
             /* if(namep.length>10){
            		$(this).find(".city-picker-span").css("line-height","");
            	}else{
            		$(this).find(".city-picker-span").css("line-height","48px");
            	}
            */	
        },
