...
public class CmsGroupDaoImpl extends HibernateBaseDao<CmsGroup, Integer>
	...
	public List<CmsGroup> getList() {
		String hql = "from CmsGroup bean order by bean.priority asc,bean.groupId asc";
		return find(hql);
	}

	public CmsGroup getRegDef() {
		String hql = "from CmsGroup bean where bean.isRegDef=true";
	...
	public CmsGroup findByName(String name){
		String hql = "from CmsGroup bean where bean.groupName=:name";
