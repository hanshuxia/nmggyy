...
import com.anchorcms.core.dao.CmsUserAccountDao;
...
public class CmsUserAccountMngImpl implements CmsUserAccountMng {
	...
	public CmsUserAccount updateAccountInfo(String accountWeiXin,
		...
		CmsUserAccount entity = dao.findById(user.getUserId());
		if (entity == null) {
			...
			//
			//Integer userId = Int(Math.random()*100+1);
			account.setUserId(1);
	...
	public CmsUserAccount userPay(Double payAmout, CmsUser authorUser) {
		CmsUserAccount entity = dao.findById(authorUser.getUserId());
