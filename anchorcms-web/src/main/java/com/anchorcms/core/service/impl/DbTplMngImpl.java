...
import com.anchorcms.core.dao.DbTplDao;
import com.anchorcms.core.model.DbTpl;
import com.anchorcms.core.tpl.ParentDirIsFileExceptioin;
...
@Service("dbTplManager")
@Transactional
public class DbTplMngImpl implements TemplateLoader, TplService {
