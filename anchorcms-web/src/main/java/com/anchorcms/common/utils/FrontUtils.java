...
public class FrontUtils {
	 ...
	 * 操作成功关闭页面
	 */
	public static final String CLOSE_PAGE = "tpl.closePage";
	/**
	 * 操作失败页面
	 */
	 ...
	 * @return
	 */
	public static String showClose(HttpServletRequest request,
	 ...
	 *@Desc 信息提示页面
	 **/
	public static String showBaseMessage(HttpServletRequest request,
