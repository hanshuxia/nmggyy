 ...
 * 自定义标签-备品备件求购
 */
@Component("s_spareDemand_list")
public class SSpareDemandListDirective implements TemplateDirectiveModel {
    ...
    public void execute(Environment env, Map params, TemplateModel[] loopVars,
        ...
        String rType = DirectiveUtils.getString("requestType", params);

        List<SSpareDemand> list = supplychainCreateService.getSpareDemandResList(count, orderBy, listType,rType);
