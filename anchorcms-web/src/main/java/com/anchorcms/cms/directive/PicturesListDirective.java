...
/**
 * @author gengwenlong
 * @Date 2017/2/10 15:48
 * @return
 * 首页轮播图展示
 */
@Component("s_pictures_list")
public class PicturesListDirective implements TemplateDirectiveModel {
    ...
    public void execute(Environment env, Map params, TemplateModel[] loopVars,
        ...
        List<PictureFistpage> list = pictureFirstpageService.getPictureFirstpageList(count, orderBy, listType);
    ...
    @Resource
    private PictureFirstpageService pictureFirstpageService;
}
