 ...
 */
@Component("s_synergy_diploma_list")
public class SynergyCompanyDiplomaListDirective implements TemplateDirectiveModel {
    ...
    public void execute(Environment env, Map params, TemplateModel[] loopVars,
        ...
        List<SCompanyDiploma > list = synergyCompanyService.getDiplomaList(count, orderBy, listType);
