 ...
 * @Desc 能力池自定义标签
 */
@Component("s_hotdemand_list")
public class SIcloudHotDemandListDirective implements TemplateDirectiveModel {
    ...
    public void execute(Environment env, Map params, TemplateModel[] loopVars,
        ...
        List<SDemand> list = sHotDemandService.getList(count, orderBy, listType);
    ...
    @Resource
    private SHotDemandService sHotDemandService;
