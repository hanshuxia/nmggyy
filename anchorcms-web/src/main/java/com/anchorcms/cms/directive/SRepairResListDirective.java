 ...
 * 供应链维修资源自定义标签
 */
@Component("s_repairRes_list")
public class SRepairResListDirective implements TemplateDirectiveModel {
    ...
    public void execute(Environment env, Map params, TemplateModel[] loopVars,
        ...
        List<SRepairRes> list = supplychainCreateService.getRepairResList(count,orderBy, listType);
