 ...
 * @Desc 能力池自定义标签
 */
@Component("s_ability_list")
public class SAbilityListDirective implements TemplateDirectiveModel {
    ...
    public void execute(Environment env, Map params, TemplateModel[] loopVars,
        ...
        String abilityType = DirectiveUtils.getString("abilityType", params);
