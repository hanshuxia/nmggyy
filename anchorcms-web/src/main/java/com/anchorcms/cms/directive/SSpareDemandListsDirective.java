...
@Component("s_spareDemand_lists")
public class SSpareDemandListsDirective implements TemplateDirectiveModel {
    ...
    public void execute(Environment env, Map params, TemplateModel[] loopVars,
        ...
        List<SSpareDemand> list = supplychainCreateService.getSpareDemandResLists(count, orderBy, listType);
