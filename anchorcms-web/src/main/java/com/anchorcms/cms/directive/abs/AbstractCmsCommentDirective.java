...
public abstract class AbstractCmsCommentDirective implements
	...
	public static final String PARAM_TOP_PARENT_ID = "topParentId";
	...
	protected Integer getTopParentId(Map<String, TemplateModel> params)
			throws TemplateException {
		return DirectiveUtils.getInt(PARAM_TOP_PARENT_ID, params);
	}
