...
/**
 * @author machao
 * @Date 2017/2/19 15:21
 * @return
 * 企业下拉框
 */
@Component("s_company_lists")
public class SCompanyListsDirective implements TemplateDirectiveModel {
    ...
    public void execute(Environment env, Map params, TemplateModel[] loopVars,
        ...
        List<SCompany> list = supplychainCreateService.getCompanyLists(count, orderBy, listType);
