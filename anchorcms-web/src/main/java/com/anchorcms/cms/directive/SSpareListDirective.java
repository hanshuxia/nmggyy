 ...
 * 自定义标签-备品备件
 */
@Component("s_spare_list")
public class SSpareListDirective implements TemplateDirectiveModel {
    ...
    public void execute(Environment env, Map params, TemplateModel[] loopVars,
        ...
        String sType = DirectiveUtils.getString("spareType", params);

        List<SSpare> list = supplychainCreateService.getSpareList(count, orderBy, listType,sType);
