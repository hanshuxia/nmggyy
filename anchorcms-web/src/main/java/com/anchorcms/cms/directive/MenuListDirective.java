...
public class MenuListDirective implements TemplateDirectiveModel {
    ...
    public void execute(Environment env, Map params, TemplateModel[] loopVars,
        ...
        Integer level = DirectiveUtils.getInt("level", params);
        String orderBy = DirectiveUtils.getString("orderBy", params);
        String menuType = DirectiveUtils.getString("menuType", params);

        //List<SSpare> list = supplychainCreateService.getSpareList(count, orderBy, listType);
        List<PubCode> list = pubCodeService.getMenu(count,level,orderBy,menuType);
