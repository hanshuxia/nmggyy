 ...
 * 自定义标签-惠补政策
 */
@Component("s_samplepolicy_list")
public class SAmplePolicyListDirective implements TemplateDirectiveModel {
    ...
    public void execute(Environment env, Map params, TemplateModel[] loopVars,
        ...
        List<SAmplePolicy> list = sAmplePolicyService.getSpareDemandResList(count, orderBy, listType);
