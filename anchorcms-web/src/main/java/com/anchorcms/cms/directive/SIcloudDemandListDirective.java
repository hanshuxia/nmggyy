 ...
 * @Desc 能力池自定义标签
 */
@Component("s_icloud_demand_list")
public class SIcloudDemandListDirective implements TemplateDirectiveModel {
    ...
    public void execute(Environment env, Map params, TemplateModel[] loopVars,
        ...
        List<SIcloudDemand> list = cloudCenterDemandService.getList(count, orderBy, listType,listId);
