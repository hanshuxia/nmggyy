 ...
 * @Desc 能力池自定义标签
 */
@Component("s_icloud_resource_list")
public class SIcloudResourceListDirective implements TemplateDirectiveModel {
    ...
    public void execute(Environment env, Map params, TemplateModel[] loopVars,
        ...
        Integer state = DirectiveUtils.getInt("state", params);
        List<SIcloudManage> list = cloudCenterResourceService.getList(count, orderBy, listType,areaType,state);
