 ...
 * @Desc 维修资源预览自定义标签
 */
@Component("s_repair_list")
public class RepairListDirective implements TemplateDirectiveModel {
    ...
    public void execute(Environment env, Map params, TemplateModel[] loopVars,
        ...
        List<SRepairRes> list = masterManagerService.getList(count, orderBy, listType,repairType);
