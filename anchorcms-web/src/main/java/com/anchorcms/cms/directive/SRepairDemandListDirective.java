 ...
 * 供应链维修需求自定义标签
 */
@Component("s_repairDemand_list")
public class SRepairDemandListDirective implements TemplateDirectiveModel {
    ...
    public void execute(Environment env, Map params, TemplateModel[] loopVars,
        ...
        List<SRepairDemand> list = supplychainCreateService.getRepairDemandList(count, orderBy, listType,demandType);
