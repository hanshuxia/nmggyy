 ...
 * @Desc 政策自定义标签
 */
@Component("s_icloud_policy_list")
public class SIcloudPolicyListDirective implements TemplateDirectiveModel {
    ...
    public void execute(Environment env, Map params, TemplateModel[] loopVars,
        ...
        List<SIcloudPolicy> list = cloudCenterPolicyService.getList(count, orderBy, listType,listId);
