 ...
 * @Desc 能力池自定义标签
 */
@Component("s_company_list")
public class SCompanyAbilityListDirective implements TemplateDirectiveModel {
    ...
    public void execute(Environment env, Map params, TemplateModel[] loopVars,
        ...
        List<SCompany> list = service.getList(count, orderBy, listType);
