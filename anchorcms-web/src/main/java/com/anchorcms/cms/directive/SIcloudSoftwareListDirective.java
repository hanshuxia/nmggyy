 ...
 * @Desc 软件自定义标签
 */
@Component("s_icloud_software_list")
public class SIcloudSoftwareListDirective implements TemplateDirectiveModel {
    ...
    public void execute(Environment env, Map params, TemplateModel[] loopVars,
        ...
        Integer listType = DirectiveUtils.getInt("type", params);//0全部1免费2付费(购买+租赁)
        Integer listId = DirectiveUtils.getInt("send", params);
        List<SSoftware> list = softwareService.getList(count, orderBy, listType,listId);
