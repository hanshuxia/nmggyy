 ...
 * @Desc 能力池自定义标签
 */
@Component("s_icloud_policy_apply_list")
public class SIcloudPolicyApplyListDirective implements TemplateDirectiveModel {
    ...
    public void execute(Environment env, Map params, TemplateModel[] loopVars,
        ...
        List<SIcloudApply> list = cloudCenterPolicyService.getApplyList(count, orderBy, listType);
