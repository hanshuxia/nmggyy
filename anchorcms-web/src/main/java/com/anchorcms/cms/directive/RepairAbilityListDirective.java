...
/**
 * Created by ${耿文龙} on 2017/2/13.
 * 金牌老师傅相似能力自定义标签
 */
@Component("s_nlxq_list")
public class RepairAbilityListDirective implements TemplateDirectiveModel {
        ...
        public void execute(Environment env, Map params, TemplateModel[] loopVars,
            ...
            String repairType = DirectiveUtils.getString("repairType", params);

            //List<SAbility> list = synergyCreateService.getList(count, orderBy, listType,abilityType);
            List<SRepairRes> list = sSpareDemandService.getList(count, orderBy, listType,repairType);
