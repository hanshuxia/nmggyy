 ...
 * 自定义标签-中标公告
 */
@Component("s_bidNotice_list")
public class SBidNoticeListDirective implements TemplateDirectiveModel {
    ...
    public void execute(Environment env, Map params, TemplateModel[] loopVars,
        ...
        List<SBidNotice> list = commserviceCreateService.getSBidNoticeList(count, orderBy, listType);
