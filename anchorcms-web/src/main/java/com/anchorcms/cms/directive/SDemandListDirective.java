 ...
 * @Desc 能力池自定义标签
 */
@Component("s_demand_list")
public class SDemandListDirective implements TemplateDirectiveModel {
    ...
    public void execute(Environment env, Map params, TemplateModel[] loopVars,
        ...
        Integer overDate = DirectiveUtils.getInt("overDate", params);
        String demandType = DirectiveUtils.getString("demandType", params);

        List<SDemand> list = sDemandService.getList(count, orderBy, listType,overDate,demandType);
