 ...
 * 自定义标签-政府网站维护
 */
@Component("s_sStiteManager_list")
public class SStiteMangerListDirective implements TemplateDirectiveModel {
    ...
    public void execute(Environment env, Map params, TemplateModel[] loopVars,
        ...
        List<SStiteManager> list = commserviceCreateService.getSstiteManagerList(count, orderBy, listType);
