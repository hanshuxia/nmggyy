 ...
 * 自定义标签-招标预告
 */
@Component("s_tenderTrailer_list")
public class STenderTrailerListDirective implements TemplateDirectiveModel {
    ...
    public void execute(Environment env, Map params, TemplateModel[] loopVars,
        ...
        List<STenderTrailer> list = commserviceCreateService.getStenderTrailerList(count, orderBy, listType);
