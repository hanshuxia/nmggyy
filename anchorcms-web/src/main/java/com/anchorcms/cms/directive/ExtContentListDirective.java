 ...
 * 内容列表标签
 */
@Component("ext_content_list")
public class ExtContentListDirective extends AbstractExtContentDirective {
	/**
	 * 模板名称
	 */
	...
	public void execute(Environment env, Map params, TemplateModel[] loopVars,
		...
		List<Object> list = getList(params, env,queryParams,modelPath);
	...
	protected List<Object> getList(Map<String, TemplateModel> params,
		...
		if (ids != null) {
			return extContentService.getListByIdsForTag(ids, getOrderBy(params),queryParams,modelPath);
		} else {
			return (List<Object>) super.getData(params, env,queryParams,modelPath);
		}
	}
