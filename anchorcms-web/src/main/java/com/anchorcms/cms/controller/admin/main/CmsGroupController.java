...
public class CmsGroupController {
    private static final Logger log = LoggerFactory.getLogger(CmsGroupController.class);
    ...
    public String save(CmsGroup bean, Integer[] viewChannelIds, Integer[] contriChannelIds,
        ...
        cmsLogMng.operating(request, "cmsGroup.log.save", "id=" + bean.getGroupId()
    ...
    public void checkname(Integer gid, HttpServletRequest request, HttpServletResponse response) {
        String name = RequestUtils.getQueryParam(request, "groupName");
        String pass;
