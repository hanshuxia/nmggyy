...
public class ContentTagController {
	...
	@RequiresPermissions("tag:v_ajax_com/anchorcms/cms/controller/admin/main/ContentTagController.java:76edit")
	...
	public String update(ContentTag bean, Integer pageNo,
		...
		log.info("update ContentTag tagId={}.", bean.getTagId());
	...
	public void checkTagname(Integer tagId,HttpServletRequest request, HttpServletResponse response) {
		String tag=RequestUtils.getQueryParam(request,"tagName");
		String pass;
	...
	private boolean vldExist(Integer id, Integer siteId, WebErrors errors) {
		...
		if (errors.ifNotExist(entity, ContentTag.class,siteId)) {
			return true;
		}
		return false;
	}
