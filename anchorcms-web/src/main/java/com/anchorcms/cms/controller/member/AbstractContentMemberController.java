 ...
 * @author ly
 */
public class AbstractContentMemberController {
	protected String list(String q, Integer modelId, Integer queryChannelId,
		...
		Pagination p = contentMng.getPageForMember(q, queryChannelId,site.getSiteId(), modelId,user.getUserId(), cpn(pageNo), 20);
