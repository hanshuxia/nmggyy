...
public class ChannelController {
	...
	public void checkPath(Integer cid,String channelPath,HttpServletRequest request, HttpServletResponse response) {
		String pass;
		if (StringUtils.isBlank(channelPath)) {
			pass = "false";
		} else {
			Channel c = manager.findByPath(channelPath, CmsUtils.getSiteId(request));
			if(c==null){
				pass="true" ;
			}else{
