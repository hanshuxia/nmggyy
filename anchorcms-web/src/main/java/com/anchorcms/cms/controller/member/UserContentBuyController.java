 ...
 */
@Controller
public class UserContentBuyController {
	...
	public String buyList(String orderNum,Integer pageNo,HttpServletRequest request,
		...
		Pagination pagination=contentBuyMng.getPage(orderNum,user.getUserId(),
	...
	public String orderList(String orderNum,Integer pageNo,HttpServletRequest request,
		...
		Pagination pagination=contentBuyMng.getPage(orderNum, null, user.getUserId(),
	...
	public String contentChargeList(Integer orderBy,
		...
		Pagination pagination=contentChargeMng.getPage(null,user.getUserId(),
