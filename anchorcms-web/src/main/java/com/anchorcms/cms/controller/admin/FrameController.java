...
public class FrameController {
	...
	public String expandMain(ModelMap model) {return "frame/expand_main"; }
	...
	private Map<String,String> tops = new HashMap<String, String>();;
	private Map<String,String>menuUrls = new HashMap<String, String>();;
	private Map<String,String>menuPerms = new HashMap<String, String>();;
	private Map<String,Map<String,String>>menuNames= new HashMap<String,Map<String,String>>();
