...
public class ConsultController {
	...
	public static final String CONSULT_PAGE = "tpl.consultPage";
	public static final String CONSULT_LIST = "tpl.consultList";
	public static final String CONSULT_INPUT = "tpl.consultInput";

	@RequestMapping(value = "/consult*.jspx", method = RequestMethod.GET)
	public String page(Integer contentId, Integer pageNo,Integer channelId,
			HttpServletRequest request, HttpServletResponse response,
			ModelMap model) {
		CmsSite site = CmsUtils.getSite(request);
		if(contentId==null){
			return FrontUtils.showMessage(request, model,
			"consult.contentNotFound");
		}
		...
		return FrontUtils.getTplPath(request, site.getSolutionPath(),
				TPLDIR_SPECIAL, CONSULT_PAGE);
	}
	
	@RequestMapping(value = "/consult_input_csi.jspx")
	public String custom(String tpl,Integer contentId, HttpServletRequest request,
		...
		FrontUtils.frontData(request, model, site);
		return FrontUtils.getTplPath(request, site.getSolutionPath(),
				TPLDIR_SPECIAL, CONSULT_INPUT);
	}

	@RequestMapping(value = "/consult_list.jspx")
	public String list(Integer siteId, Integer contentId, Integer parentId,
		...
		List<CmsConsult> list = cmsConsultMng.getListForTag(siteId, contentId,
		...
		FrontUtils.frontData(request, model, site);
		return FrontUtils.getTplPath(request, site.getSolutionPath(),
				TPLDIR_CSI, CONSULT_LIST);
	}

	@RequestMapping(value = "/consult.jspx", method = RequestMethod.POST)
	public void submit(Integer contentId, Integer parentId,Integer score,
		...
		if (content == null) {
			...
			cmsConsultMng.consult(score,text, RequestUtils.getIpAddr(request),
	...
	@RequestMapping(value = "/consult_up.jspx")
	public void up(Integer consultId, HttpServletRequest request,
			HttpServletResponse response) {
		if (exist(consultId)) {
			cmsConsultMng.ups(consultId);
	...
	@RequestMapping(value = "/consult_down.jspx")
	public void down(Integer consultId, HttpServletRequest request,
			HttpServletResponse response) {
		if (exist(consultId)) {
			cmsConsultMng.downs(consultId);
			ResponseUtils.renderJson(response, "true");
		} else {
			ResponseUtils.renderJson(response, "false");
		}
	...
	private boolean exist(Integer id) {
		...
		CmsConsult consult = cmsConsultMng.findById(id);
		return consult != null;
	}
