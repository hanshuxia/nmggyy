...
import com.anchorcms.cms.ueditor.define.AppInfo;
...
import com.anchorcms.cms.ueditor.hunter.ImageHunter;
import com.anchorcms.cms.ueditor.upload.StorageManager;
import com.anchorcms.common.image.ImageScale;
import com.anchorcms.common.image.ImageUtils;
import com.anchorcms.common.ueditor.LocalizedMessages;
import com.anchorcms.common.ueditor.ResourceType;
import com.anchorcms.common.ueditor.Utils;
...
public class UeditorAct {
	...
	private JSONObject doUpload(HttpServletRequest request, String typeStr, Boolean mark) throws Exception {
		...
		try {
			...
			cmsUserMng.updateUploadSize(user.getUserId(), Integer.parseInt(String
