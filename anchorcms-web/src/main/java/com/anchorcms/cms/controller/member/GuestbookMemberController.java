...
import static com.anchorcms.common.constants.Constants.TPLDIR_GUESTBOOK;
...
public class GuestbookMemberController {
	...
	public String myguestbook(Integer pageNo, Integer ctgId,
		...
		Pagination pagination = guestbookMng.getPage(site.getSiteId(), ctgId,null,
				user.getUserId(), null, null, true, false, cpn(pageNo), CookieUtils
				.getPageSize(request));
