...
@Controller
public class CmsAdvertisingSpaceController {
	private static final Logger log = LoggerFactory
			.getLogger(CmsAdvertisingSpaceController.class);
	...
	public String list(Integer pageNo, HttpServletRequest request,
		...
		List<CmsAdvertisingSpace> list = manager.getList(site.getSiteId());
	...
	public void ajaxEdit(Integer id, HttpServletRequest request,HttpServletResponse response, ModelMap model) throws JSONException {
		...
		if(space!=null){
			object.put("adspaceId", space.getAdspaceId());
			object.put("adName", space.getAdName());
			object.put("description", space.getDescription());
			object.put("isEnabled", space.getIsEnabled());
		}
	...
	public String save(CmsAdvertisingSpace bean, HttpServletRequest request,
		...
		log.info("save CmsAdvertisingSpace adspaceId={}", bean.getAdspaceId());
		cmsLogMng.operating(request, "cmsAdvertisingSpace.log.save", "adspaceId="
				+ bean.getAdspaceId() + ";adName=" + bean.getAdName());
	...
	public String update(CmsAdvertisingSpace bean, Integer pageNo,
		...
		WebErrors errors = validateUpdate(bean.getAdspaceId(), request);
		if (errors.hasErrors()) {
			return errors.showErrorPage(model);
		}
		bean = manager.update(bean);
		log.info("update CmsAdvertisingSpace adspaceId={}.", bean.getAdspaceId());
		cmsLogMng.operating(request, "cmsAdvertisingSpace.log.update", "adspaceId="
				+ bean.getAdspaceId() + ";adName=" + bean.getAdName());
	...
	public String delete(Integer[] ids, Integer pageNo,
		...
		for (CmsAdvertisingSpace bean : beans) {
			log.info("delete CmsAdvertisingSpace adspaceId={}", bean.getAdspaceId());
			cmsLogMng.operating(request, "cmsAdvertisingSpace.log.delete",
					"adspaceId=" + bean.getAdspaceId() + ";adName=" + bean.getAdName());
		}
		return list(pageNo, request, model);
	}
