...
import com.anchorcms.cms.dao.assist.CmsAccountPayDao;
...
import com.anchorcms.common.utils.PayUtil;
import com.anchorcms.common.utils.WeixinPay;
...
public class CmsAccountPayMngImpl implements CmsAccountPayMng {
	...
	private void afterPay(Integer drawId,CmsUser drawUser,CmsUser payUser,
		...
		pay.setPayTime((Timestamp) payTime);
