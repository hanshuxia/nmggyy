...
import com.anchorcms.cms.model.assist.CmsWebserviceParam;
...
public class CmsWebserviceMngImpl implements CmsWebserviceMng {
	...
	public String callWebService(CmsWebservice webservice,Map<String,String>paramsValues){
		String endpoint =webservice.getServiceAddress();
		...
		try {
			...
			call.setOperationName(new QName(webservice.getTargetNamespace(), webservice.getServiceOperate()));
