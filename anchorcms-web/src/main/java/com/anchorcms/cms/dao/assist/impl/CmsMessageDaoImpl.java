...
public class CmsMessageDaoImpl extends HibernateBaseDao<CmsMessage, Integer>
	...
	public Pagination getPage(Integer siteId, Integer sendUserId,
		...
		if(sendUserId != null&&receiverUserId != null){
			finder.append(" and (msg.msgSendUser.userId=:sendUserId or msg.msgReceiverUser.userId=:receiverUserId)").setParam(
					"sendUserId", sendUserId).setParam("receiverUserId", receiverUserId);
		}else{
			if (sendUserId != null) {
				finder.append(" and msg.msgSendUser.userId=:sendUserId").setParam(
						"sendUserId", sendUserId);
			}
			if (receiverUserId != null) {
				finder.append(" and msg.msgReceiverUser.userId=:receiverUserId")
		...
		finder.append(" order by msg.msgId desc");
