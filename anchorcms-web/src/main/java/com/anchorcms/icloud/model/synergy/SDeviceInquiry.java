 ...
 */
@Entity
@Table(name = "s_device_inquiry")
@org.hibernate.annotations.Cache(usage = CacheConcurrencyStrategy.READ_WRITE )
public class SDeviceInquiry implements Serializable{
    private static final long serialVersionUID = 5324598035311841056L;
    ...
    public boolean equals(Object o) {
        ...
        SDeviceInquiry that = (SDeviceInquiry) o;
        ...
        return scompanyDevice != null ? scompanyDevice.equals(that.scompanyDevice) : that.scompanyDevice == null;
    ...
    public int hashCode() {
        ...
        result = 31 * result + (scompanyDevice != null ? scompanyDevice.hashCode() : 0);
        return result;
    }
    ...
    private SCompanyDevice scompanyDevice;
    ...
    public SCompanyDevice getScompanyDevice() {
        return scompanyDevice;
    }

    public void setScompanyDevice(SCompanyDevice scompanyDevice) {
        this.scompanyDevice = scompanyDevice;
    }
}
