...
@Service
@Transactional
public class STenderTrailerServiceImpl implements STenderTrailerService {

	public STenderTrailer findById(int id) {
		STenderTrailer entity = dao.findById(id);
		return entity;
	}
    /**
     * @author gengwenlong
	...
	public Content relese(STenderTrailer stt, HttpServletRequest request, Content c, ContentExt ext, ContentTxt t, String nextUrl, Integer modelId,
		...
		stt.setContent(c);
		/*stt.setTenderTrailerId(c.getContentId());*/
		dao.relese(stt);
		afterSave(c);
		return c;
	}
	...
	@Resource
	private STenderNoticeDao sTenderNoticeDao;
